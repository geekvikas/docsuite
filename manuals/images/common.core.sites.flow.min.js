function GetSearchURL() {
    ...
    if(typeof prodPage !=='undefined')
        ...
        return "search/index.html?nomatch=true";
}
...
function runChrome(f, e) {
 ...
 var arrowWidth = 350;
 // TODO: Change these params to resize PopUp Window or reposition it
 
 var padding = 80;  // This will move window left and down
 
 var width = (window.innerWidth / 2);
 var top = window.top.screenY + padding;
 var left = window.top.screenX + width - padding;
 var height = window.top.innerHeight - top;
 
 // Uncomment the block to show the Audio Prompt and arrow
 /*
 width = (window.innerWidth / 2) - arrowWidth;
