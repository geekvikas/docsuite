...
function runChrome(f, e) {
    searchurl = "search/" + findProd(document.getElementById('product-manual-search').value) + "?q=" + document.getElementById('product-manual-search').value;
...
popupWindow2 = window.open(searchurl, 
        "_blank", "directories=no, status=no, menubar=no, scrollbars=yes, resizable=no," + 
        "width=" + (width - 10) + 
        ",height="  + height +
